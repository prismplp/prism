...
print('[SAVE] fb15k237.'+args.file_type+'_pos.dat')
with open('fb15k237.'+args.file_type+'_pos.dat', 'w') as fp:
	for item in target_data:
		if item is not None:
			fp.write("rel(%d,%d,%d).\n"%item)
		else:
...
print('[SAVE] fb15k237.'+args.file_type+'_neg1'+'.dat')
with open('fb15k237.'+args.file_type+'_neg1'+'.dat', 'w') as fp:
...
print('[SAVE] fb15k237.'+args.file_type+'_neg2'+'.dat')
with open('fb15k237.'+args.file_type+'_neg2'+'.dat', 'w') as fp:
