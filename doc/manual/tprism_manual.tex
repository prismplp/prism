...
The usage of the tprism command is explained in \prettyref{sec:tprism_command}.
...
The details of additional flags for T-PRISM are described in \prettyref{sec:tprism_predicate}.
...
where {\tt data.h5} contains placeholders and is generated by the predicates described in \prettyref{sec:tprism_predicate}.
...
as \prettyref{fig:nn}.   We train this  neural network using  the cross-entropy loss
function.
