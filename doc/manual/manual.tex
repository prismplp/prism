...
\hypersetup{pdftitle={PRISM User's Manual (Version 2.2)}}
...
\end{verbatim}
\end{quote}
where random switches are shared with {\tt prefix\_pcfg/1-2} above.
...
\end{quote}
%
where {\tt get\_samples/1} generates {\tt N} sentences, {\tt maplist/4}
converts them into {\tt N} prefix substrings, and finally {\tt lin\_learn/1}
learns parameters from such prefix substrings.
