...
double compute_likelihood_vb_scaling_none(void)
{
    int i;
    ...
    adjuster =
        failure_observed ?
        (log(1.0 - inside_failure) - log(inside_failure)): 0.0;
...
double compute_likelihood_vb_scaling_log_exp(void)
{
    int i;
    double likelihood,adjuster,inside;
    ...
    adjuster =
        failure_observed ?
        (log(1.0 - exp(inside_failure)) - log(inside_failure)) : 0.0;
