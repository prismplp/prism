...
%PRISM%\prism_win32.exe -c -p %PAREA% -s %STACK% -b %TRAIL% -t %TABLE% %PRISM%\bp.out %PRISM%\prism.out %PRISM%\foc.out %PRISM%\batch.out %1 %2 %3 %4 %5 %6 %7 %8 %9
...
%PRISM%\prism_win32.exe -c -p %PAREA% -s %STACK% -b %TRAIL% -t %TABLE% %PRISM%\bp.out %PRISM%\prism.out %PRISM%\foc.out %PRISM%\batch.out %*
